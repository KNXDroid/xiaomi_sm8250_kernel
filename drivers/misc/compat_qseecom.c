...
static const unsigned int qseecom_compat_cmd_map[] = {
	[1] = QSEECOM_IOCTL_REGISTER_LISTENER_REQ,
	[2] = QSEECOM_IOCTL_UNREGISTER_LISTENER_REQ,
	[3] = QSEECOM_IOCTL_SEND_CMD_REQ,
	[4] = QSEECOM_IOCTL_SEND_MODFD_CMD_REQ,
	[5] = QSEECOM_IOCTL_RECEIVE_REQ,
	[6] = QSEECOM_IOCTL_SEND_RESP_REQ,
	[7] = QSEECOM_IOCTL_LOAD_APP_REQ,
	[8] = QSEECOM_IOCTL_SET_MEM_PARAM_REQ,
	[9] = QSEECOM_IOCTL_UNLOAD_APP_REQ,
	[10] = QSEECOM_IOCTL_GET_QSEOS_VERSION_REQ,
	[11] = QSEECOM_IOCTL_PERF_ENABLE_REQ,
	[12] = QSEECOM_IOCTL_PERF_DISABLE_REQ,
	[13] = QSEECOM_IOCTL_LOAD_EXTERNAL_ELF_REQ,
	[14] = QSEECOM_IOCTL_UNLOAD_EXTERNAL_ELF_REQ,
	[15] = QSEECOM_IOCTL_APP_LOADED_QUERY_REQ,
	[16] = QSEECOM_IOCTL_SEND_CMD_SERVICE_REQ,
	[17] = QSEECOM_IOCTL_CREATE_KEY_REQ,
	[18] = QSEECOM_IOCTL_WIPE_KEY_REQ,
	[19] = QSEECOM_IOCTL_SAVE_PARTITION_HASH_REQ,
	[20] = QSEECOM_IOCTL_IS_ES_ACTIVATED_REQ,
	[21] = QSEECOM_IOCTL_SEND_MODFD_RESP,
	[23] = QSEECOM_IOCTL_SET_BUS_SCALING_REQ,
	[24] = QSEECOM_IOCTL_UPDATE_KEY_USER_INFO_REQ,
	[30] = QSEECOM_QTEEC_IOCTL_OPEN_SESSION_REQ,
	[31] = QSEECOM_QTEEC_IOCTL_CLOSE_SESSION_REQ,
	[32] = QSEECOM_QTEEC_IOCTL_INVOKE_MODFD_CMD_REQ,
	[33] = QSEECOM_QTEEC_IOCTL_REQUEST_CANCELLATION_REQ,
	[34] = QSEECOM_IOCTL_MDTP_CIPHER_DIP_REQ,
	[35] = QSEECOM_IOCTL_SEND_MODFD_CMD_64_REQ,
	[36] = QSEECOM_IOCTL_SEND_MODFD_RESP_64,
};
...
static unsigned int convert_cmd(unsigned int cmd)
{
	...
	if (nr >= sizeof(qseecom_compat_cmd_map) /
			sizeof(qseecom_compat_cmd_map[0]))
		return cmd;

	native_cmd = qseecom_compat_cmd_map[nr];
	return native_cmd ? native_cmd : cmd;
}
